...
import com.mebooth.mylibrary.imagepicker.DataHolder;
import com.mebooth.mylibrary.imagepicker.ImageDataSource;
import com.mebooth.mylibrary.imagepicker.ImagePicker;
import com.mebooth.mylibrary.imagepicker.adapter.ImageFolderAdapter;
import com.mebooth.mylibrary.imagepicker.adapter.ImageRecyclerAdapter;
import com.mebooth.mylibrary.imagepicker.bean.ImageFolder;
import com.mebooth.mylibrary.imagepicker.bean.ImageItem;
import com.mebooth.mylibrary.imagepicker.util.Utils;
import com.mebooth.mylibrary.imagepicker.view.FolderPopUpWindow;
import com.mebooth.mylibrary.imagepicker.view.GridSpacingItemDecoration;
 ...
 *         ================================================
 */
public abstract class ImageGridActivity extends ImageBaseActivity implements ImageDataSource.OnImagesLoadedListener, ImageRecyclerAdapter.OnImageItemClickListener, ImagePicker.OnImageSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nocrop = getIntent().getBooleanExtra("nocrop", false);
...
//        mRecyclerAdapter.notifyItemChanged(position + (imagePicker.isShowCamera() ? 1 : 0));// 17/4/24  fix the position while click right bottom preview button
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (ImagePicker.REQUEST_CODE_CROP == requestCode && data == null) {
